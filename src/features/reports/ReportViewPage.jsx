...
const ReportViewPage = () => {
    ...
    case "stock":
      ...
      columns = [
        ...
        },
        {
          ...
          renderCell: (params) =>
            formatCurrency(params.row.currentStock * params.row.unitPrice),
        },
      ];
      rows = mockItems;
      break;
    ...
    case "issue-return":
      ...
      columns = [
        { field: "code", headerName: "Transaction Code", width: 150 },
        {
          ...
          width: 110,
          valueGetter: (v, row) =>
            row.code.startsWith("ISS") ? "Issue" : "Return",
        },
        {
          field: "date",
          headerName: "Date",
        ...
        },
        {
          ...
          headerName: "Employee",
          width: 160,
          valueGetter: (v, row) => row.issuedTo || row.returnedBy,
        },
  ...
  const handleExportExcel = () => {
    const exportData = rows.map((r) => {
      const cleanObj = {};
      columns.forEach((col) => {
        cleanObj[col.headerName] =
          r[col.field] !== undefined ? r[col.field] : "";
      });
      return cleanObj;
    });
