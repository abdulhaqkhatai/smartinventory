...
const ChangePasswordPage = () => {
  ...
  const getPasswordStrength = (pwd) => {
    if (!pwd) return { score: 0, label: '', color: '#546E7A' };
    let score = 0;
    ...
    if (score <= 25) return { score, label: 'Weak', color: '#FF5252' };
    if (score <= 50) return { score, label: 'Fair', color: '#FFB74D' };
    if (score <= 75) return { score, label: 'Good', color: '#29B6F6' };
            ...
            <Box component="form" onSubmit={handleSubmit}>
              ...
              <TextField
                ...
                InputProps={{
                  ...
                  endAdornment: confirmPassword && confirmPassword === newPassword ? (
                    <InputAdornment position="end">
